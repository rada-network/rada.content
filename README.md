...
Therefore, to be able to contribute and synchronize data between [rada.network] (http://rada.network] (http://rada.network) and rada.content, the directory structure and database synchronization is crucial. Here we will structure the rada.content archive into folders where each folder will be a collection.
